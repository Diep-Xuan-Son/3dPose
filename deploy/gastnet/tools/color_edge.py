...
custom_backbone = [7, 8, 9, 10]
custom_leg_left = [5, 6]
custom_leg_right = [2, 3]
custom_arm_left = [12, 13]
custom_arm_right = [15, 16]
custom_shoulder = [1, 4, 11, 14]

def custom_color_edge(joint_num):
    if joint_num in custom_backbone:
        color = 'black' 
    elif joint_num in custom_arm_left:
        color = 'aqua'  
    elif joint_num in custom_arm_right:
        color = 'lawngreen' 
    elif joint_num in custom_leg_left:
        color = 'navy'  
    elif joint_num in custom_leg_right:
        color = 'darkgreen' 
    elif joint_num in custom_shoulder:
        color = 'chocolate'  
    else:
        color = 'yellow'  
    return color